...
void check_pass()
{
    ...
    EGGS_TEST_DETAIL_CHECK(r);
    EGGS_TEST_DETAIL_CHECK(s.assertions_passed == 1);
    EGGS_TEST_DETAIL_CHECK(s.assertions_failed == 0);
}
...
void check_fail()
{
    ...
    EGGS_TEST_DETAIL_CHECK(!r);
    EGGS_TEST_DETAIL_CHECK(s.assertions_passed == 0);
    EGGS_TEST_DETAIL_CHECK(s.assertions_failed == 1);
}
...
void check_throws_pass()
{
    ...
    EGGS_TEST_DETAIL_CHECK(ep != nullptr);
    EGGS_TEST_DETAIL_CHECK(s.assertions_passed == 1);
    EGGS_TEST_DETAIL_CHECK(s.assertions_failed == 0);
}
